...
- Evaluated LLMs under cost, quality, and latency trade-offs
...
ML models for censored survival data in healthcare.

- Built risk-scoring models for leukemia progression
- Modeled censored time-to-event data with robust evaluation

---

## 📈 Financial ML & Time Series

Financial forecasting and portfolio modeling.

- Built models for return prediction and portfolio allocation
